...
class DessertStationController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if (auth()->user()->num_system > $dess){
            ...
            return response()->json([
                'status' => 403,
                'message' => 'You do not have permission to create another resolution model .',
                'success' => false
            ], 403);
        }
    }
    ...
    public function getSearchStation(Request $request){
        ...
        if(!$request->name_station_search){
            ...
            $dessert = DessertStation::query()
                ...
                ->where('name', 'LIKE',"%$request->name_station_search%")->orWhere('name_ar', 'LIKE',"%$request->name_station_search%")
                ->orderBy('id', 'ASC')
                ->select($arr)->get();
        }
        return response()->json([
