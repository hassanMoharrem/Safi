    ...
    <div class="container">
        <div class="row justify-content-center align-items-center all-login min-vh-100">
            <div class="col-md-5 text-center">
                <div class="rounded-30 shadow-login p-3 mt-5 bg-main">
                    ...
                    <div class="text-center my-3">
                        <form method="post" action="{{ route('admin.login.store') }}" novalidate>
                            ...
                            <div class="mb-3 text-start">
                                ...
                                <input class="form-control shadow-input padding-input mt-0 border-transparent bg-sub text-white font-14" id="email" value="{{ old('email') }}" name="email" type="email" placeholder="Email" aria-label="default input example">
                                @error('email')
                            ...
                            <div class="mb-3 text-start">
                                ...
                                <input class="form-control shadow-input padding-input mt-0 border-transparent bg-sub text-white font-14" id="password" name="password" type="password" placeholder="Password" aria-label="default input example">
                                @error('password')
                                <div class="text-danger font-12 mt-2">{{ $message }}</div>
                                @enderror
                            </div>
